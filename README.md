# Looker Extension tw_rebate_create_section_ext

tw_rebate_create_section_ext is a Looker extension using React and TypeScript.
...
5. Create a `manifest` file
   ...
   ```
    ...
    application: tw_rebate_create_section_ext {
        label: "tw_rebate_create_section_ext React/TypeScript extension"
