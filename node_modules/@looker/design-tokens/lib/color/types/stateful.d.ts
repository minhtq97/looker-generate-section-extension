export declare type StatefulColor = 'key' | 'critical' | 'neutral' | 'positive';
...
export interface StatefulColors extends CriticalStatefulColors, ExtendedStateColors, KeyStatefulColors, NeutralStatefulColors, PositiveStatefulColors {
}
