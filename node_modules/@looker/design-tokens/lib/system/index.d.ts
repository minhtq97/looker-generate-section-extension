...
export { background, borderRadius, boxShadow, backgroundPosition, color, display, flexbox, fontSize, fontFamily, fontWeight, lineHeight, letterSpacing, fontStyle, height, layout, maxWidth, minWidth, overflow, padding, position, space, size, system, textAlign, typography, variant, verticalAlign, width, } from 'styled-system';
...
export type { BackgroundProps, BackgroundColorProps, BackgroundPositionProps, BorderRadiusProps, BoxShadowProps, DisplayProps, FlexboxProps, HeightProps, LayoutProps, MaxHeightProps, MaxWidthProps, MinWidthProps, OpacityProps, OverflowProps, PaddingProps, PositionProps, ResponsiveValue, SizeProps, VerticalAlignProps, WidthProps, } from 'styled-system';
export declare type HTMLAttributeStyledSystemConflictKeys = 'as' | 'color' | 'height' | 'label' | 'ref' | 'size' | 'width';
export declare type CompatibleHTMLProps<T> = Omit<HTMLProps<T>, HTMLAttributeStyledSystemConflictKeys>;
export declare type CompatibleInputHTMLProps<T> = Omit<InputHTMLAttributes<T>, HTMLAttributeStyledSystemConflictKeys>;
