...
var ExtensionEvent = exports.ExtensionEvent = function (ExtensionEvent) {
...
var ExtensionRequestType = exports.ExtensionRequestType = function (ExtensionRequestType) {
...
var ApiVersion = exports.ApiVersion = function (ApiVersion) {
  ApiVersion["sdk40"] = "4.0";
  return ApiVersion;
}({});
var FetchResponseBodyType = exports.FetchResponseBodyType = function (FetchResponseBodyType) {
  FetchResponseBodyType["json"] = "json";
  FetchResponseBodyType["text"] = "text";
  return FetchResponseBodyType;
}({});
var ExtensionNotificationType = exports.ExtensionNotificationType = function (ExtensionNotificationType) {
...
var MountPoint = exports.MountPoint = function (MountPoint) {
