...
class ExtensionHostApiImpl {
  ...
  handleNotification(message) {
    ...
    switch (type) {
      ...
      default:
        (0, _util.logError)('Unrecognized extension notification', message);
  ...
  error(errorEvent) {
    if (this._lookerHostData) {
      ...
      (0, _util.logError)('Unhandled error but Looker host connection not established', errorEvent);
    }
  }
  unloaded() {
