...
export declare class Looker40SDKStream extends APIMethods {
    ...
    sync_lookml_dashboard(callback: (response: Response) => Promise<number[]>, lookml_dashboard_id: string, body: Partial<IWriteDashboard>, raw_locale?: boolean, options?: Partial<ITransportSettings>): Promise<number[]>;
