...
class BrowserTransport extends _baseTransport.BaseTransport {
  ...
  retry(request) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var newOpts = (0, _transport.mergeOptions)(_this.options, (_request$options = request.options) !== null && _request$options !== void 0 ? _request$options : {});
      ...
      var waiter = newOpts.waitHandler || _transport.retryWait;
      var response = (0, _transport.initResponse)(method, requestPath);
      ...
      var _loop = function* _loop() {
        ...
        if ((0, _transport.canRetry)(response.statusCode) && attempt < maxRetries) {
          var result = yield (0, _transport.pauseForRetry)(request, response, attempt, waiter);
          if (result.response === 'cancel') {
            ...
            return {
              v: (0, _transport.retryError)(response)
            };
          }
        } else {
          return "break";
