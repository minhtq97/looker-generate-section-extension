...
class BaseTransport {
  ...
  initRequest(method, path, body, authenticator, options) {
    ...
    return _asyncToGenerator(function* () {
      ...
      var agentTag = ((_options = options) === null || _options === void 0 ? void 0 : _options.agentTag) || _this.options.agentTag || _transport.agentPrefix;
      var agent = {
        headers: {
          [_transport.LookerAppId]: agentTag
        }
      };
      options = (0, _transport.mergeOptions)(_objectSpread(_objectSpread({}, _this.options), agent), (_options2 = options) !== null && _options2 !== void 0 ? _options2 : {});
      ...
      if (AbortSignal.timeout) {
        var ms = (0, _transport.sdkTimeout)(options) * 1000;
