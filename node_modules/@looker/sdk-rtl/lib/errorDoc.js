...
var ErrorCodesUrl = exports.ErrorCodesUrl = 'https://static-a.cdn.looker.app/errorcodes/';
var ErrorDocNotFound = exports.ErrorDocNotFound = '### No documentation found for ';
...
var ErrorDocRx = exports.ErrorDocRx = RegExp(ErrorDocPatternExpression, 'i');
...
class ErrorDoc {
  ...
  specPath(path) {
    var result = path.replace(/:\w+/g, found => "{".concat(found.substring(1), "}"));
    return result;
  }
  errorKey(docUrl) {
